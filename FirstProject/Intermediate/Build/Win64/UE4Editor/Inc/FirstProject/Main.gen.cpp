...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AMain_Statics::NewProp_BaseTurnRate_MetaData[] = {
		{ "Category", "Camera" },
		{ "Comment", "/* Base turn rates to scale turning function for the camera */" },
		{ "ModuleRelativePath", "Main.h" },
		{ "ToolTip", "Base turn rates to scale turning function for the camera" },
	};
#endif
	...
	IMPLEMENT_CLASS(AMain, 1838055996);
